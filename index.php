    ...
    <div class="container">
      ...
      <form class="ajax" method="post" action="ajax.php">
          ...
          <div class="form-actions">
              <button class="btn btn-large btn-primary" type="submit">Вийти</button>
          </div>
      </form>
      ...
      <form class="form-signin ajax" method="post" action="ajax.php">
        ...
        <h2 class="form-signin-heading">Будь-ласка ввійдіть</h2>
        ...
        <button class="btn btn-large btn-primary" type="submit">Ввійти</button>
